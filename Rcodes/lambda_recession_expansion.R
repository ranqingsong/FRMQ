...
par(mfrow =c(2,2))
#comparing the overlaying plot during recession and expansion for Americas
#during expansion  - financial crisis of 2008
plot(density(AM_data1[,1],na.rm = T, kernel = "gaussian"), type = "h", ylim = c(0,100), xlim=c(0,0.20),
      main = "", xlab = "lambdas before and after financial crisis of 2008", cex.lab=2,cex.axis=2, ylab="")
...
plot(density(AM_data1[,197],na.rm = T, kernel = "gaussian"), type = "h", ylim = c(0,100), xlim=c(0,0.20),
      main = "", xlab = "labmdas during fincancial crisis of 2008", col="gray", cex.lab=2,cex.axis=2, ylab="")
  for (i in 198:587) {
...
plot(density(AM_data2[,1],na.rm = T, kernel = "gaussian"), type = "h", ylim = c(0,100), xlim=c(0,0.20), 
      main = "", xlab = "lambdas before Covid-19 pandemic", cex.lab=2,cex.axis=2, ylab="")
  for (i in 2:304) {
    lines(density(AM_data2[,i],na.rm = T, kernel = "gaussian"), type = "h")  
  }
#during recession- COVID-19 pandemic
plot(density(AM_data2[,305],na.rm = T, kernel = "gaussian"), type = "h", ylim = c(0,100), xlim=c(0,0.20), 
      main = "", xlab = "lambdas during Covid-10 pandemic", col="gray", cex.lab=2,cex.axis=2, ylab="")
  for (i in 306:dim(AM_data2)[2]) {
    lines(density(AM_data2[,i],na.rm = T, kernel = "gaussian"), type = "h", col="gray")  
  }

#comparing the overlaying plot during recession and expansion for Europe 
#during expansion - financial crisis of 2008
par(mfrow =c(2,2))
...
#during recession - financial crisis of 2008
plot(density(EU_data1[,262],na.rm = T, kernel = "gaussian"), type = "h", ylim = c(0,100), xlim=c(0,0.20), 
      main = "", xlab = "lambdas during financial crisis of 2008", col="gray", cex.lab=2,cex.axis=2, ylab="")
  for (i in 263:587) {
...
plot(density(EU_data2[,262],na.rm = T, kernel = "gaussian"), type = "h", ylim = c(0,100), xlim=c(0,0.20), 
      main = "", xlab = "lambdas during Covid-19 pandemic", col="gray", cex.lab=2,cex.axis=2, ylab="")
...
plot(density(EU_frm1[c(1:261,588:719),]$FRM_index, kernel = "gaussian"), ylim=c(0,60), main= paste("during expansion", date_start1, "to",date_end1),
      xlab = "", ylab="",xlim=c(0,0.15),cex.lab=2,cex.axis=2, cex.main=2)
...
plot(density(EU_frm2[c(1:261),]$FRM_index, kernel = "gaussian"), ylim=c(0,200), main= paste("during expansion", date_start2, "to",date_end2),
      xlab = "", ylab="",xlim=c(0,0.15),cex.lab=2,cex.axis=2, cex.main=2)
