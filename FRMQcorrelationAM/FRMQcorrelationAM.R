...
## import FRM datasets
frm_data = read.csv("FRM_all_AM.csv", colClasses = c("Date", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric"))
...
write.csv(scaled_data, file = "systemic_risk_comparison_AM.csv", row.names = FALSE, quote = FALSE)
...
par(mfrow = c(1, 2))
plot(scaled_data$date[1:datecut], scaled_data$GT[1:datecut], xaxt = "none", type = "l", xlab = "", col = "darkblue", ylab = "", ylim = c(0, 
    1), lwd = 3, cex.axis = 2, cex.lab = 2)
...
plot(scaled_data$date[1:datecut], scaled_data$FRM_q50[1:datecut], xaxt = "none", type = "l", lty = 1, xlab = "", ylab = "", ylim = c(0, 
    1), cex.axis = 2, cex.lab = 2, col = "darkred", lwd = 2)
...
lines(scaled_data$date[(datecut + 1):length(scaled_data$date)], scaled_data$FT[(datecut + 1):length(scaled_data$date)], type = "l", col = "violet", 
    lwd = 2)
lines(scaled_data$date[(datecut + 1):length(scaled_data$date)], scaled_data$SRISK[(datecut + 1):length(scaled_data$date)], type = "l", 
    col = "darkgreen", lwd = 3)
lines(scaled_data$date[(datecut + 1):length(scaled_data$date)], scaled_data$VIX[(datecut + 1):length(scaled_data$date)], type = "l", 
    col = "red", lwd = 3)
...
plot(scaled_data$date[(datecut + 1):length(scaled_data$date)], scaled_data$FRM_q50[(datecut + 1):length(scaled_data$date)], type = "l", 
    lty = 1, xlab = "", ylab = "", ylim = c(0, 1), cex.axis = 2, xaxt = "none", cex.lab = 2, col = "darkred", lwd = 2)
