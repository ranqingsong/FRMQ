...
################ input scaled data#################
data <- read.csv("systemic_risk_comparison_EU.csv", colClasses = c("numeric", "numeric", "numeric", "numeric", "numeric", "numeric", 
...
####### Causality FRM_index and VSTOXX ############### from FRM_index to VSTOXX ###
...
####### Causality FRM_q50 and VSTOXX ############### from FRM_q50 to VSTOXX ###
...
####### Causality FRM_q60 and VSTOXX ############### from FRM_q60 to VSTOXX ###
...
####### Causality FRM_q70 and VSTOXX ############### from FRM_q70 to VSTOXX ###
...
####### Causality FRM_q80 and VSTOXX ############### from FRM_q80 to VSTOXX ###
...
####### Causality FRM_q90 and VSTOXX ############### from FRM_q90 to VSTOXX ###
...
####### Causality FRM_iqr and VSTOXX ############### from FRM_iqr to VSTOXX ###
...
####### Causality FRM_index and CISS ############### from FRM_index to CISS ###
...
####### Causality FRM_q50 and CISS ############### from FRM_q50 to CISS ###
...
####### Causality FRM_q60 and CISS ############### from FRM_q60 to CISS ###
...
####### Causality FRM_q70 and CISS ############### from FRM_q70 to CISS ###
...
####### Causality FRM_q80 and CISS ############### from FRM_q80 to CISS ###
...
####### Causality FRM_q90 and CISS ############### from FRM_q90 to CISS ###
...
####### Causality FRM_iqr and CISS ############### from FRM_iqr to CISS ###
lm_SF = lm(data$CISS ~ data$FRM_iqr)
summary(lm_SF)
res_lm_SF = resid(lm_SF)
res.ADF <- ur.df(res_lm_SF, type = "none", selectlags = "AIC")
